      ...
      <div className="mx-auto max-w-6xl px-6 grid grid-cols-1 md:grid-cols-[1fr_1.5fr_1fr] gap-8 items-start">
        ...
        <div>
          ...
          <ul className="space-y-1 text-sm  list-disc leading-relaxed pl-5">
            ...
            <li>
              <a href="#directions" className="hover:text-brand">
                Направления
              </a>
            </li>
            <li>
              <a href="#brands" className="hover:text-brand">
                Бренды
              </a>
            </li>
            <li>
        ...
        <div className="min-w-[340px]">
          ...
          <p className="text-sm leading-snug mt-1">
            Почта:{' '}
            <a href="mailto:info@unibrand.ru" className="text-brand hover:underline">
              info@unibrand.ru
            </a>
          </p>
          <p className="text-sm leading-snug mt-1">

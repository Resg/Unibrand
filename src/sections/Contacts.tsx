          ...
          <div className="rounded-2xl bg-white p-6 text-slate-800 shadow-lg backdrop-blur">
            ...
            <form className="mt-4 space-y-4" onSubmit={e => e.preventDefault()}>
              <div>
                ...
                <input
                  className="mt-1 w-full rounded-xl border border-gray-200 px-4 py-3 outline-none focus:ring-2 focus:ring-brand"
              ...
              <button className="w-full rounded-xl bg-brand px-5 py-3 font-medium text-white hover:opacity-90 transition">
                Отправить
              </button>
